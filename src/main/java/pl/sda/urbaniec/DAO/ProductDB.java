...
public class ProductDB {
    ...
    private ProductDB() {
        ...
        this.productList.add(new Product(0L, LocalDateTime.now(), "Couch",
        ...
        this.productList.add(new Product(1L, LocalDateTime.now(), "Lamp",
        ...
        this.productList.add(new Product(2L, LocalDateTime.now(), "Umbrella",
                "Protect from rain and bad mood", 80, "Other items", "https://hirmercdn.de/1/19700400/hirmer-du-y-parasol-niebieski_0_1600.jpg"));
    }
